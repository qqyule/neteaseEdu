...
var attention_module = (function () {
	...
	'<div class="m-login">\
        <div class="login">\
            ...
            <h2>登录云课堂</h2>\
            <form id="login-form">\
                <input type="text" placeholder="账号" name="userName" class="user" required maxlength="11">\
	...
	var fol = $.ge('.g-fol .follow'),
	    fold = $.ge('.followed'),
		login_url = "//study.163.com/webDev/login.htm",
		fol_url = "//study.163.com/webDev/attention.htm",
 ...
 */
 var get_course = (function () {
 	...
 	var c_url = "//study.163.com/webDev/couresByCategory.htm",	
...
var topHot_moudel = function () {
	...
	var ulNode = $.ge('.m-toplit'),
		t_url = '//study.163.com/webDev/hotcouresByCategory.htm',
		scollTimer;
